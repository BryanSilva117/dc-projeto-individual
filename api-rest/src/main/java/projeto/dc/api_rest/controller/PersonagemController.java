...
public class PersonagemController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PersonagemListagemDto> atualizar(@PathVariable Integer id, @RequestBody @Valid PersonagemCriacaoDto personagemAtt) {
    ...
    public ResponseEntity<PersonagemListagemDto> reativar(@PathVariable Integer id) {
